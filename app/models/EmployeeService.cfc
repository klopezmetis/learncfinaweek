<!---
	EmployeeService
	Handles all database access for the employees table.
	WireBox registers this automatically as "EmployeeService" because autoMapModels is on in config/Coldbox.cfc.
	singleton="true" means WireBox creates one instance and reuses it for every request.
--->
