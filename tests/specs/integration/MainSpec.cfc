			...
			() => {
				...
				it(
					...
					() => {
						...
						expect(event.getValue("relocate_event", ""))
							.toBe("main.index");
					}
				);
				...
				it(
					...
					() => {
						...
						var exceptionBean = createMock(
							"coldbox.system.web.context.ExceptionBean"
						)
							.init(
